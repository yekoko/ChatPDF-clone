      ...
      {messages.map((message) =>
        message.role === "user" ? (
          <div key={message.id} className="flex flex-row-reverse gap-3">
            <div className="w-3/5 flex flex-col gap-2 border px-3 py-2 rounded-lg bg-slate-50 border-slate-200/80 font-normal">
          ...
          <div key={message.id} className="flex items-end gap-3">
            ...
            <div className="w-3/5 flex flex-col gap-2 px-2 pt-3">
